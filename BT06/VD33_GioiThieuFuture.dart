...
+ Nhân viên phục vụ nói "vâng, tôi sẽ mang món ăn đến sau" (lận về một Future)
...
- Một hàm được đánh dấu async sẽ luôn luôn trả về một Future (ngay cả khi bạn không khai báo nó)
*/
...
Future<String> layHo() async {
  return "Nguyen";
}

Future<String> taiDuLieu() async {
  return Future.delayed(Duration(seconds: 2), () => "Du lieu đã tải xong  ");
}
